...
@section('contenido')
    <div class="md:flex md:justify-center mt-10 md:gap-5 md:items-center">
        <div class="md:w-6/12 mb-8 p-5 md:p-0">
            <img src="{{ asset('img/registrar.jpg') }}" alt="Imagen Sing Up">
        </div>
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form action="{{ route('register.store') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="name" name="name" type="text" value="{{ old('name') }}"
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="username" name="username" value="{{ old('username') }}" type="text"
                ...
                <div class="mb-5">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation" type="password"
                        placeholder="Confirmar Password" class="border p-3 w-full rounded-lg">
